...
class BonusDayCalculatorSpec extends ObjectBehavior
{
    ...
    {
        $this->getBonusDayByYearMonth('2020', 1)->shouldBe('15-01-2020');
    }

    function it_can_return_correct_bonus_day_on_saturday()
    {
        $this->getBonusDayByYearMonth('2015', 8)->shouldBe('19-08-2015');
    }

    function it_can_return_correct_bonus_day_on_sunday()
    {
        $this->getBonusDayByYearMonth('2015', 2)->shouldBe('18-02-2015');
    }
}
